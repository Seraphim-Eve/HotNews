    ...
    public String blogDelete(@RequestParam String blog_id) throws SQLException{
        ...
        while (rs.next()) {
            ...
            if (good_id != null && !good_id.isEmpty()) {
                ...
                if (MySQLUtils.insert(sql)) {
                    System.out.println("删除blog_id:" + blog_id + "的赞成功!");
                } else {
                    System.out.println("删除blog_id:" + blog_id + "的赞失败!");
                }
            }
            ...
            if (discuss_id != null && !discuss_id.isEmpty()) {
                ...
                if (MySQLUtils.insert(sql)) {
                    System.out.println("删除blog_id:" + blog_id  + "的评论成功!");
                } else {
                    System.out.println("删除blog_id:" + blog_id  + "的评论失败!");
                }
            }
        ...
        if (MySQLUtils.insert(sql)) {
            System.out.println("删除博客blog_id:" + blog_id + "成功!");
        } else {
            //TODO 处理删除失败
            System.out.println("删除博客blog_id:" + blog_id + "失败!");
        }
    ...
    public String blogCreate(@ModelAttribute Blog blog, HttpSession session, ModelMap modelMap, @RequestParam String op) throws SQLException {
        if (!op.isEmpty()) {
            if (op.equals("create")) {
                ...
                if (MySQLUtils.insert(sql)) {
                    modelMap.put("msg", "更新博客成功!");
                } else {
                    modelMap.put("msg", "更新博客失败!");
                }
