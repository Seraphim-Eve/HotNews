    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            ...
            <button class="btn btn-default btn-sm">
                <a href="blog_editor.do?op=create&id=" target="_blank"><span class="glyphicon glyphicon-edit"></span>新建博客</a>
            </button>
        </div>
                ...
                <li class="list-group-item title">
                    ...
                    <c:if test="${blog.getFlag() eq 'true'}">
                        <div class="btn-group btn-group-xs pull-right">
                            <button id="editor" type="button" class="btn btn-default"><a href="blog_editor.do?id=${blog.getId()}&op=update" target="_blank">编辑</a></button>
