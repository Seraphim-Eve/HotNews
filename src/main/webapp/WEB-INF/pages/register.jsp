    ...
    <div class="container">
        ...
        <form id="register" action="register.do" method="POST" class="form-signin">
            ...
            <div class="form-group">
                <input id="nickname" type="text" name="nickname" class="form-control" placeholder="昵称" maxlength="10" autofocus>
            </div>

            <div class="form-group">
                <input id="email" type="email" name="email" class="form-control" placeholder="邮箱" maxlength="30">
            </div>
